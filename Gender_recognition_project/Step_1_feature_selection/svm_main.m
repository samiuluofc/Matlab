% This main program will do SBS feature selection for SVM with the help of
...
err = fitness_svm(bin); % Initial error value
...
for i = 1:1:57 % 57 dimensional feature vector
    ...
    err_new = fitness_svm(new_bin); % calculate average error
