% This main program will do SBS feature selection for DTree with the help of
...
err = fitness_tree(bin); % Initial error value
...
for i = 1:1:57 % 57 dimensional feature vector
    ...
    err_new = fitness_tree(new_bin); % calculate average error
