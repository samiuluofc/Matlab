function F = feature_set1(img)
    ...
    H = hsv_img(:,:,1);%Ranges from 0 to 1
    S = hsv_img(:,:,2);%Ranges from 0 to 1
    V = hsv_img(:,:,3);%Ranges from 0 to 1
    ...
    % Hue Circular Variance (Although I am confused about the implementation)
