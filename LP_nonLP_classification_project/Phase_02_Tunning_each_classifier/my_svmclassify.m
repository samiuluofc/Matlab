function [outclass,prob] = my_svmclassify(svmStruct,sample, varargin)
...
%   $Revision: 1.1.22.1 $  $Date: 2011/12/27 15:39:34 $
...
if ~isempty(sample)
    ...
    try
        [outclass,prob] = my_svmdecision(sample,svmStruct);
    catch ME
