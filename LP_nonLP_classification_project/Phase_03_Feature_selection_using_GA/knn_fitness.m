function err = knn_fitness(bin_ch)
% -------------------------------------------------------------------------
% This is the Fitness function for the feature selection of K nearest 
% neighbor Classifier using GA. Parameter "bin_ch" is the binary chromosome
