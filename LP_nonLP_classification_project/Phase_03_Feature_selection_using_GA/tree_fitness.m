function err = tree_fitness(bin_ch)
% -------------------------------------------------------------------------
% This is the Fitness function for the feature selection of Decision tree
% classifier using GA. Parameter "bin_ch" is the binary chromosome
